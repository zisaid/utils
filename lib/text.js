...
text.wordTokenizer = function (article) {
...
text.sentenceTokenizer = function (article) {
...
text.paragraphTokenizer = function (article) {
    return article.split(/\n\r?/);
};

module.exports = text;

console.log(text.sentenceTokenizer('we\nare you\n\r'));
